...
let biggerThanLuke = (arr) => {
  ...
  return arr.filter(obj =>
    (obj.name !== 'Luke Skywalker') && (obj.mass > Number(arr[0].mass))
...
------------------------------------------------------------------------------------------------ */
const isSecure = (url) => {
  let reg = /^https:\/\//; return reg.test(url);
...
------------------------------------------------------------------------------------------------ */
  ...
  const helpCheck = (row1, col1, row2, col2, row3, col3, arr) => {
    if (arr[row1][col1] === arr[row2][col2] && arr[row1][col1] === arr[row3][col3] && arr[row1][col1] !== '') { return true; } else if (arr[row1][col3] === arr[row2][col2] && arr[row1][col3] === arr[row3][col1] && arr[row1][col3] !== '') { return true; } else if (arr[row1][col1] === arr[row2][col1] && arr[row1][col1] === arr[row3][col1] && arr[row1][col1] !== '') { return true; } else if (arr[row1][col2] === arr[row2][col2] && arr[row1][col2] === arr[row3][col2] && arr[row1][col2] !== '') {
      return true;
    } else if (arr[row1][col3] === arr[row2][col3] &&
      arr[row1][col3] === arr[row3][col3] &&
      arr[row1][col3] !== '') { return true; }
    else if (arr[row1][col1] === arr[row1][col2] &&
      arr[row1][col1] === arr[row1][col3] &&
      arr[row1][col3] !== '') { return true; }
    else if (arr[row2][col1] === arr[row2][col2] &&
      arr[row2][col1] === arr[row2][col3] &&
      arr[row2][col3] !== '') { return true }
    else if (arr[row3][col1] === arr[row3][col2] &&
      arr[row3][col1] === arr[row3][col3] &&
      arr[row3][col3] !== '') {
      return true;
    } else { return false; }
  }
  const detectTicTacToeWin = (board) => {
    ...
    return helpCheck(0, 0, 1, 1, 2, 2, board)
  };
